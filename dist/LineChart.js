...
data.slice(1).forEach(function(_ref,i){var _ref2=_slicedToArray(_ref,2),_=_ref2[0],dataPoint=_ref2[1];
...
return(
_react2.default.createElement(Surface,{width:containerWidth,height:containerHeight+3},
...
};_this.state={opacity:new _reactNative.Animated.Value(0)};return _this;}_createClass(LineChart,[{key:'componentWillUpdate',value:function componentWillUpdate(){_reactNative.Animated.timing(this.state.opacity,{duration:0,toValue:0}).start();}},{key:'componentDidUpdate',value:function componentDidUpdate(){_reactNative.Animated.timing(this.state.opacity,{duration:500,toValue:1}).start();}},{key:'render',value:function render()

{
return(
_react2.default.createElement(_reactNative.View,null,
_react2.default.createElement(_Grid2.default,this.props),
_react2.default.createElement(_reactNative.Animated.View,{style:{opacity:this.state.opacity,backgroundColor:'transparent'}},
this._drawLine())));
